...
public class LoadDialog extends Dialog {
    ...
    private String mMsg;
    private static final String STRING_DEFAULMSG = "加载中";
    public static final String STRING_LOGINMSG = "登录中";
    public static final String STRING_LOGOUT = "退出中";
    public static final String STRING_UPIMGS = "上传中";
    public static final String STRING_CHECKCHANGE = "验收中";
    public static final String STRING_MODIFY = "修改中";
        ...
        public void handleMessage(Message msg) {
            ...
            if (null != loadDialog) {
                switch (loadDialog.mCurrentInt) {
                    case INT_NULL:
                        loadDialog.mTextView.setText((loadDialog.mMsg == null ? STRING_DEFAULMSG : loadDialog.mMsg) + STRING_NULL);
                        loadDialog.mCurrentInt++;
                        break;
                    case INT_BEFOR:
                        loadDialog.mTextView.setText((loadDialog.mMsg == null ? STRING_DEFAULMSG : loadDialog.mMsg) + STRING_BEFOR);
                        loadDialog.mCurrentInt++;
                        break;
                    case INT_IN:
                        loadDialog.mTextView.setText((loadDialog.mMsg == null ? STRING_DEFAULMSG : loadDialog.mMsg) + STRING_IN);
                        loadDialog.mCurrentInt++;
                        break;
                    case INT_LAST:
                        loadDialog.mTextView.setText((loadDialog.mMsg == null ? STRING_DEFAULMSG : loadDialog.mMsg) + STRING_LAST);
    ...
    public static void showLoading(Context context) {
        ...
        loadDialog.mTextView.setText(STRING_DEFAULMSG + STRING_NULL);
